...
coverage:
	which py.test
	py.test --cov-report term-missing --cov tickethelpdesk -n 2

coverage-live:
	which py.test
	py.test --livetest --cov-report term-missing --cov tickethelpdesk

coverage-html:
	py.test --cov-report html --cov tickethelpdesk
